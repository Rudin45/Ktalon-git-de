...
String desc = WebUI.getText(findTestObject('04 - Confluent/02 - StoreDeposit/Recon/descRecon'))

WebUI.verifyMatch(GlobalVariable.reconDesc, desc.substring(1, 66), false, FailureHandling.CONTINUE_ON_FAILURE)

String code = WebUI.getText(findTestObject('04 - Confluent/02 - StoreDeposit/Recon/codeRecon'))

WebUI.verifyMatch(GlobalVariable.reconCode, code.substring(1, 28), false, FailureHandling.CONTINUE_ON_FAILURE)

...
WebUI.click(findTestObject('04 - Confluent/02 - StoreDeposit/inRequest/1 - stgClusterLink'))

WebUI.waitForPageLoad(30)

WebUI.delay(3)

WebUI.click(findTestObject('04 - Confluent/02 - StoreDeposit/inRequest/2 - stgAzure'))
...
String amount = WebUI.getText(findTestObject('04 - Confluent/02 - StoreDeposit/inResponse/16 - valueResponse'))

...
String fee = WebUI.getText(findTestObject('04 - Confluent/03 - Card-Request/Kiwi Request/fee'))

amountRecon = ((amount) as Double)

feeRecon = ((fee) as Double)

amountReconTotal = (amountRecon + feeRecon)

println(amountRecon)

println(feeRecon)

println(amountReconTotal)
...
WebUI.clearText(findTestObject('04 - Confluent/02 - StoreDeposit/inRequest/4 - searchTopic'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(1)

WebUI.setText(findTestObject('04 - Confluent/02 - StoreDeposit/inRequest/4 - searchTopic'), 'recon')

WebUI.delay(3)

WebUI.click(findTestObject('04 - Confluent/02 - StoreDeposit/Recon/a_recon_financial_events'))
...
amount = WebUI.getText(findTestObject('04 - Confluent/02 - StoreDeposit/Recon/amountRecon'))

String amountR = amountReconTotal

WebUI.verifyMatch(amountR, amount, false, FailureHandling.CONTINUE_ON_FAILURE)

String desc = WebUI.getText(findTestObject('04 - Confluent/03 - Card-Request/Recon/descRecon'))

WebUI.verifyMatch(GlobalVariable.reconDescMPos, desc.substring(1, 63), false, FailureHandling.CONTINUE_ON_FAILURE)

String code = WebUI.getText(findTestObject('04 - Confluent/02 - StoreDeposit/Recon/codeRecon'))

WebUI.verifyMatch(GlobalVariable.reconDescMPos, code.substring(1, 28), false, FailureHandling.CONTINUE_ON_FAILURE)

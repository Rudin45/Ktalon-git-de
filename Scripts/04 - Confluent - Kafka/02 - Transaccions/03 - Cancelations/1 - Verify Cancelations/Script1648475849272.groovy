...
WebUI.setText(findTestObject('04 - Confluent/02 - StoreDeposit/inRequest/4 - searchTopic'), 'cancellation')

WebUI.click(findTestObject('04 - Confluent/04 - Cancelations/01 - ewallet Cancelation'))
...
WebUI.scrollToElement(findTestObject('04 - Confluent/04 - Cancelations/10 - amount description'), 30)

WebUI.delay(2)

String amount = WebUI.getText(findTestObject('04 - Confluent/04 - Cancelations/03 - amount Value'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(GlobalVariable.e2eSDvalue, amount, false, FailureHandling.CONTINUE_ON_FAILURE)

String name = WebUI.getText(findTestObject('04 - Confluent/04 - Cancelations/04 - type'))

WebUI.verifyMatch('"cancellation"', name, false, FailureHandling.CONTINUE_ON_FAILURE)

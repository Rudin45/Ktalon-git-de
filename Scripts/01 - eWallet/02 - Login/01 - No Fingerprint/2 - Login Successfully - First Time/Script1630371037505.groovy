...
Mobile.setText(findTestObject('01 - eWallet/02 - Login/03 - Nuevo Numero de Celular'), GlobalVariable.phoneNumber, 10)

Mobile.setText(findTestObject('01 - eWallet/02 - Login/04 - Password'), GlobalVariable.password, 10)

Mobile.tap(findTestObject('01 - eWallet/02 - Login/06 - Ingresar Button'), 10)

Mobile.tap(findTestObject('01 - eWallet/02 - Login/08 - En Otro momento'), 10)

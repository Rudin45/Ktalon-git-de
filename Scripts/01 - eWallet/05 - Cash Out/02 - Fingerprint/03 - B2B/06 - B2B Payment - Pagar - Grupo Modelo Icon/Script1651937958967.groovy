...
Mobile.waitForElementPresent(findTestObject('01 - eWallet/05 - CashOut/03 - B2B/02 - Grupo Modelo Icon'), 20)

Mobile.verifyElementVisible(findTestObject('01 - eWallet/05 - CashOut/03 - B2B/02 - Grupo Modelo Icon'), 20)

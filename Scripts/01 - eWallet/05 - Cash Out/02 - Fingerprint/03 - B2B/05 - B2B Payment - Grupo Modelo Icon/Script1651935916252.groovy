...
Mobile.waitForElementPresent(findTestObject('01 - eWallet/05 - CashOut/03 - B2B/01 - Grupo Modelo Attribute'), 20)

Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('01 - eWallet/05 - CashOut/03 - B2B/01 - Grupo Modelo Attribute'), 20)

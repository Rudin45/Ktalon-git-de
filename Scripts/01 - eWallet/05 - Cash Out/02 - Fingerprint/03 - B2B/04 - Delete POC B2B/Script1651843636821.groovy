...
Mobile.waitForElementPresent(findTestObject('01 - eWallet/05 - CashOut/03 - B2B/12 - Eliminar'), 10)

Mobile.tap(findTestObject('01 - eWallet/05 - CashOut/03 - B2B/12 - Eliminar'), 5, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.delay(3, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.waitForElementPresent(findTestObject('01 - eWallet/05 - CashOut/03 - B2B/13 - Continuar Button'), 10)

Mobile.tap(findTestObject('01 - eWallet/05 - CashOut/03 - B2B/13 - Continuar Button'), 10)

...
Mobile.verifyElementVisible(findTestObject('01 - eWallet/06 - Profile/01 - General/02 - Manten'), 10)

Mobile.verifyElementText(findTestObject('01 - eWallet/06 - Profile/01 - General/02 - Manten'), 'Mantén actualizada tu información.')

Mobile.verifyElementVisible(findTestObject('01 - eWallet/06 - Profile/01 - General/03 - Image'), 10)

Mobile.verifyElementVisible(findTestObject('01 - eWallet/06 - Profile/01 - General/04 - User Name'), 10)

Mobile.verifyElementText(findTestObject('01 - eWallet/06 - Profile/01 - General/04 - User Name'), GlobalVariable.userName)
...
Mobile.verifyElementVisible(findTestObject('01 - eWallet/06 - Profile/01 - General/06 - Editar Pencil'), 10)
...
Mobile.verifyElementVisible(findTestObject('01 - eWallet/06 - Profile/01 - General/09 - Acerca'), 10)

Mobile.verifyElementText(findTestObject('01 - eWallet/06 - Profile/01 - General/09 - Acerca'), 'Acerca de SíHay')

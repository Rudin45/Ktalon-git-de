...
WebUI.click(findTestObject('02 - Admin Portal/03 - Client Transactions/10 Export Button'))

WebUI.waitForPageLoad(30)

WebUI.click(findTestObject('02 - Admin Portal/03 - Client Transactions/11 - Export to Excel'))

WebUI.waitForPageLoad(30)

WebUI.delay(10)

WebUI.click(findTestObject('02 - Admin Portal/03 - Client Transactions/12 - Close'))

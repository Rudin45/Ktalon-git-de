...
WebUI.click(findTestObject('02 - Admin Portal/01 - Login/logInButton'))
...
WebUI.setText(findTestObject('02 - Admin Portal/01 - Login/password'), 'Ignacio@02')

WebUI.click(findTestObject('02 - Admin Portal/01 - Login/iniciarSesionButton'))

WebUI.waitForPageLoad(30)

WebUI.verifyElementPresent(findTestObject('02 - Admin Portal/01 - Login/errorMessage'), 30)

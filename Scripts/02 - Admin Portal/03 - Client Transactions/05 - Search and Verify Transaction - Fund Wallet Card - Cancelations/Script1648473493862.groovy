...
WebUI.verifyMatch(payMethod, 'Card', false, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyMatch(amountValue.substring(0, 3), GlobalVariable.e2eCvalue, false, FailureHandling.CONTINUE_ON_FAILURE)

String statusValue = WebUI.getText(findTestObject('02 - Admin Portal/03 - Client Transactions/06 - Transaction Status Value'))

WebUI.verifyMatch(statusValue, 'Cancelled', false, FailureHandling.CONTINUE_ON_FAILURE)

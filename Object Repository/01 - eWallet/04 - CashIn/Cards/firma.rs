...
<MobileElementEntity>
   ...
   <locator>new UiSelector().className(&quot;android.view.View&quot;).packageName(&quot;sihay.wallet.mx.development&quot;).enabled(true).clickable(false).longClickable(false).checkable(false).checked(false).focusable(false).focused(false).scrollable(false).selected(false).index(0)</locator>
